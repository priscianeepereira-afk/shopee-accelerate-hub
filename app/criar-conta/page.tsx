...
// Criar Conta — mesmo fundo gradiente warm→cool do Login.
// Componentes Bloom usados (sem criar nada novo):
//   - BloomInput  (label + campo + prop error)
//   - BloomButton (CTA "Criar conta" e "Já tenho conta")
// Campos: Email, Nome Completo, Senha (4–6), Confirmar Senha.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CTA secundário — volta para login */}
        <BloomButton
          type="button"
          variant="ghost"
          size="lg"
