...
// Login — alinhado ao spec V2/DESCRICAO DE TELAS/Login.md
// Componentes Bloom usados (sem criar nada novo):
//   - BloomInput  (label + campo)
//   - BloomButton (CTA "Entrar")
// Tela fora do AppLayout (sem sidebar). Submit sem validação → /integrations.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CTA secundário — ida para cadastro */}
        <BloomButton
          type="button"
          variant="ghost"
          size="lg"
